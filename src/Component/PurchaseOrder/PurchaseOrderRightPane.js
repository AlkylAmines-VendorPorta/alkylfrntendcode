...
import AdvanceShipmentNotice from "../../Component/AdvanceShipmentNotice/AdvanceShipmentNotice/AdvanceShipmentNotice";
class PurchaseOrderRightPane extends Component {
       ...
       <div className={this.state.showPO?"block":"none"}>
         ...
         <PurchaseOrder filter={this.props.filter} onFilterChange={this.handleFilterChange} onFilter={this.handleFilterClick} poList={this.props.poList} user={this.props.user} 
           ...
           <div className={((this.state.showCreateASN) || (this.state.showASNHistory))?"block mt-100":"none"}>
             <AdvanceShipmentNotice newRole={this.state.role} po={this.state.po} costCenterList={this.state.costCenterList} ssnFundList={this.state.ssnFundList} poLineArray={this.state.poLineList} serviceList={this.state.serviceList}
...
export default connect (mapStateToProps,actionCreators)(PurchaseOrderRightPane);
