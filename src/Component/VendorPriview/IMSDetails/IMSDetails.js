...
import { 
    commonHandleFileUpload, commonSetState, commonSubmitForm, commonHandleChangeCheckBox, 
  ...
  render() {
    return (
      ...
      <div className="card">
        ...
        <FormWithConstraints className="mt-2 mb-3" ref={formWithConstraints => this.forms = formWithConstraints} 
           onSubmit={(e)=>{commonSubmitForm(e,this,"saveIMSDetailsResponse","/rest/saveIMSDetails")}} noValidate > 
          ...
          <div className="row">
            ...
            <div className="col-sm-3">
              <select className={"form-control "} readOnly={this.props.readonly} name="inspectionStandard" value={this.state.inspectionStandard}  onChange={(e)=>{commonHandleChange(e,this,"inspectionStandard")}}>
          ...
          <div className="row">
            ...
            <div className="col-sm-3">
              <input type="date" className={"form-control "} readOnly={this.props.readonly} name="iso14001ValidUpto" 
          ...
          <div className="row">
            ...
            <label className="col-sm-1">Valid Upto</label>
            <div className="col-sm-3">
              <input type="date" className={"form-control "} readOnly={this.props.readonly} name="iso9001ValidUpto" 
          ...
          <div className="row">
            ...
            <label className="col-sm-1">Valid Upto</label>
            <div className="col-sm-3">
              <input type="date" className={"form-control "} readOnly={this.props.readonly} name="iso50001ValidUpto" 
          ...
          <div className="row">
            ...
            <label className="col-sm-1">Valid Upto</label>
            <div className="col-sm-3">
              <input type="date" className={"form-control "} readOnly={this.props.readonly} name="ohsms45001ValidUpto" 
              value={this.state.ohsms45001ValidUpto} 
              onChange={(e)=>{commonHandleChange(e,this,"ohsms45001ValidUpto")}} />
            </div>
            <div className="col-sm-3">
              <input type="hidden" disabled={isEmpty(this.state.ohsms45001Attachment.attachmentId)} value={this.state.ohsms45001Attachment.attachmentId} name="ohsms45001Attachment[attachmentId]" />
              <input type="file" className={"form-control "+this.props.readonly} 
              onChange={(e)=>{commonHandleFileUpload(e,this,"ohsms45001Attachment")}} />
          ...
          <div className="row">
            ...
            <label className="col-sm-1">Valid Upto</label>
            <div className="col-sm-3">
              <input type="date" className={"form-control "} readOnly={this.props.readonly} name="isRCLogoValidUpto" 
          ...
          <div style={{display:"none"}} className={"col-sm-12 text-center mt-3 " + this.props.displayDiv}>
