...
class PRContainer extends Component {
  ...
  componentDidMount(){
    ...
    commonSubmitWithParam(this.props,"getPR","/rest/getPRReportMaster"); 
    commonSubmitWithParam(this.props,"getFilterData","/rest/getPRStatus");
    this.changeLoaderState(true);
  }

  componentWillReceiveProps(props){
    console.log("WILL CONTAINER props",props);
    ...
    if(!isEmptyDeep(props.filterObject)){
      ...
      this.setState({filterBuyerList,filterPlantList,filterPRStatusList})
    }
  ...
  onFilter = () => {
    ...
    let params = {}
    let arr = ['prDateFrom','prDateTo','prNoFrom','prNoTo','status','buyerCode','plant'];
  ...
  onFetch = (params) => {
    ...
    console.log("this.props on fetch",this.props,params)
    commonSubmitWithObjectParams(this.props,"getPR",'/rest/getPRByFilter',params);
    this.changeLoaderState(true);
  }

  render() {
    console.log("this.state.prlist container",this.state.prList);
    return (
      <>
