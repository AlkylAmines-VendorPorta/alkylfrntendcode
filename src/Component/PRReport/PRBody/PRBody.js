...
import { getUserDto, getFileAttachmentDto,removeLeedingZeros } from "../../../Util/CommonUtil";
...
class PRBody extends Component {
  ...
  componentWillReceiveProps = props=>{
    console.log("props will rec",props);
            ...
            <div className="card my-2">
              ...
              <div className="row mt-0 px-4 pt-1">
                ...
                <div className="col-6 col-md-2 col-lg-2">
                  ...
                  <span className="display_block">
                    {this.state.prDetails.prNumber + " - "+ this.state.prDetails.date}
                  </span>
                </div>
                  ...
                  <div className="col-12">
                    <div className="d-flex justify-content-center">
                      ...
                      <>
                        ...
                        {/* <button className="btn btn-sm btn-outline-success mr-2"><i className="fa fa-check"/>&nbsp;Release</button> */}
