...
<div className="modal-content" style={{width:"800px", maxWidth:"800px"}}>
  ...
  <div className="row px-4 py-2">
    { [ROLE_REQUISTIONER_ADMIN,ROLE_APPROVER_ADMIN,ROLE_BUYER_ADMIN,"PRTAB"].includes(this.props.role) &&
        <>
        ...
        <div className="row mt-2">
                      ...
                      <div className="col-sm-4">
                        <label>From </label>
                        <input type="number" className="form-control"  value={filter.prNoFrom} onChange={this.handleFilterChange.bind(this,'prNoFrom')} />
                      </div>
                
                      <div className="col-sm-4">
                        <label>To </label>
                        <input type="number" className="form-control"  value={filter.prNoTo} onChange={this.handleFilterChange.bind(this,'prNoTo')} />
                      </div>
       ...
       <div className="row mt-2">
                     ...
                     <div className="col-sm-4">
                       <label>From </label>
                       <input type="date" className="form-control" max="9999-12-31" value={filter.prDateFrom} onChange={this.handleFilterChange.bind(this,'prDateFrom')} />
                     </div>
               
                     <div className="col-sm-4">
                       <label>To </label>
                       <input type="date" className="form-control" max="9999-12-31"  value={filter.prDateTo} onChange={this.handleFilterChange.bind(this,'prDateTo')} />
                     </div>
      ...
      <label className="col-sm-2">Status </label>
            ...
            <label className="col-sm-2">buyer </label>
            <div className="col-sm-4">
