...
const asngateentryReducer = (state = defaultState, action) => {
...
}else if (action.type === "POPULATE_PO_FOR_ASN") {
  return {
    ...state,
...
else if (action.type === "REJECT_ASN_BUTTON") {

  return {
    ...state,
    asnRejectButton: action.payload.message,
...
}else if (action.type === "POPULATE_ASN_LIST_FOR_COMMERCIAL") {
  return {
      ...state,
      asnList: action.payload.objectMap.asnList,
    
  };
}else if (action.type === "ASN_GATE_IN_STATUS") {
  return {
    ...state,
    asnList: action.payload.objectMap.asnList
  };
}else if (action.type === "ASN_ID") {
  return {
    ...state,
    asnLists: action.payload.objectMap.asnList
  };
}
else {
    return {
...
export default asngateentryReducer;
