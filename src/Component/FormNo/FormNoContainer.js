...
import FormNoContainerRightPane from "./FormNoContainerRightPane";
...
class FormNoCont extends Component {
    ...
    return (
      ...
      <div className="page-content">
        <div className="wizard-v1-content mt-100">
          ...
          <FormNoContainerRightPane filter={this.state.filter} 
...
const mapStateToProps=(state)=>{
  return state.formNoContReducer;
};
export default connect (mapStateToProps,)(FormNoCont);