...
class FormNoContainerRightPane extends Component {
    ...
    return (
      <>
          ...
          Advance Shipment Notice Details
            ...
            <FormNo filter={this.props.filter} onFilterChange={this.handleFilterChange} onFilter={this.handleFilterClick}  unload={this.state.unload} grn={this.state.grn} qc={this.state.qc} po={this.state.po} poLineArray={this.state.poLineList}
...
export default FormNoContainerRightPane;