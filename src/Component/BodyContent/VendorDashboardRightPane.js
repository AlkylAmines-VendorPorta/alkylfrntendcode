...
class VendorDashboardRightPane extends Component {
      ...
      <>
        ...
        <div className="col-sm-12" id="togglesidebar">
            <div className={this.state.showPO?"block":"none"}>
              ...
              <VendorDashboardMainBody filter={this.props.filter} onFilterChange={this.handleFilterChange} onFilter={this.handleFilterClick}  poList={this.props.poList} user={this.props.user} 
...
export default connect (mapStateToProps,actionCreators)(VendorDashboardRightPane);
